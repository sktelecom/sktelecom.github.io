...
작성일에 해당하는 연도 디렉토리(예: [/2026](../content/ko/blog/2026)) 하위에 작성할 블로그를 위한 디렉토리를 생성합니다. 쉽게 하려면 같은 연도 디렉토리에 있는 기존 게시물 디렉토리를 하나 복사해서 사용하세요. 디렉토리는 "yyyymmdd_title" 형태의 이름으로 생성합니다.

```
$ cd 2026/
$ cp -R ./20260604_sbom_generator ./20260907_new-post
```

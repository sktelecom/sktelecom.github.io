...
weight: 10
type: docs
description: 1991년 [Free Software Foundation](http://www.fsf.org/)에서 만든 대표적인 Copyleft 라이선스인 [GPL-2.0](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html)은 재배포 시 소스 코드 공개를 요구하기 때문에 사용에 주의가 필요합니다.
---
...
1. GPL-2.0은 파생저작물에도 GPL-2.0을 적용하여 소스 코드를 공개할 것을 요구합니다. 아래 내용을 참고하여 GPL-2.0 하의 오픈소스와 파생저작물의 소스 코드를 공개합니다.

{{% alert title="GPL-2.0 파생저작물의 범위" color="warning" %}}
...
![GPL-2.0 파생저작물의 범위](gpl-2.0-derivative-scope.svg "같은 프로세스 안에서 결합되면 파생저작물, 프로세스 경계를 넘어 통신하면 별도 저작물")
...
{{% alert title="Apache-2.0과의 비호환성" color="warning" %}}
...
* [GPL-2.0 License 원문](https://www.gnu.org/licenses/old-licenses/gpl-2.0.html)

...
1. LGPL-2.1은 파생저작물에도 LGPL-2.1을 적용하여 소스 코드를 공개할 것을 요구합니다. 아래 내용을 참고하여 LGPL-2.1 하의 오픈소스와 파생저작물의 소스 코드를 공개합니다.
...
![LGPL-2.1의 공개 범위](lgpl-2.1-disclosure-scope.svg "라이브러리 자체는 공개 대상, 동적 링크한 프로그램은 공개 의무 없음, 정적 링크한 실행파일은 오브젝트 코드 제공")

...
> `dir:` 스캔은 로컬에서 라이선스를 확인하는 용도입니다. 제출용 SBOM은 패키지 매니저 컨텍스트(빌드된 이미지나 lockfile)가 있는 대상에서 생성해야 purl이 채워집니다. 자세한 내용은 [SBOM 생성 방법](/guide/supply-chain/for-suppliers/creation-guide/)을 참고하세요.
...
> 보고된 사례와 안전 사용법은 [SBOM 생성 방법](/guide/supply-chain/for-suppliers/creation-guide/)을 참고하세요.

자동화 도구를 활용한 SBOM 생성은 [SBOM 생성 방법](/guide/supply-chain/for-suppliers/creation-guide/)을 참고하시기 바랍니다.

...
|---|---|---|---|
| EU 인공지능법 (EU AI Act) | 모델을 공개하는 경우 | 2025년 8월 2일부터 | 제53조 |
...
- 모델을 공개하는 쪽에 걸리는 것은 제53조입니다. 기술 문서, 저작권 정책, 학습 콘텐츠 요약
  공개를 요구하며 이미 적용 중입니다.
- 가중치와 구조를 오픈소스 라이선스로 공개하면 기술 문서 의무는 면제되지만, 저작권 정책과
  [학습 콘텐츠 요약 공개](https://digital-strategy.ec.europa.eu/en/library/explanatory-notice-and-template-public-summary-training-content-general-purpose-ai-models)는

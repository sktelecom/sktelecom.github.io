...
모델 가중치와 학습 데이터처럼 일반 SBOM이 표현하지 못하는 층을 담습니다.
...
아래는 규제 준수를 인증하거나 판정하는 것이 아닙니다. 문서화가 어디까지 갖춰졌는지 드러내 사람이
준비할 수 있게 하는 자료입니다. 특정 시스템의 법적 의무를 해석하는 일은 사람의 몫이며, 판단이
필요하면 법무 부서와 OSRB에 문의하시기 바랍니다.
{{% /alert %}}

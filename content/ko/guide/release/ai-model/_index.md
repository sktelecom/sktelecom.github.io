...
2. 모델과 학습 데이터셋의 라이선스를 각각 확인합니다. 여기서 걸리면 나머지 준비가 무의미해지므로
   일찍 확인하시는 편이 좋습니다.
3. [공개 전 체크리스트](checklist/)와 [모델 카드](model-card/)를 함께 진행합니다. 모델 카드는
   공개 후 가장 많이 읽히는 문서입니다.
4. 규제 대응이 필요하면 [AI SBOM](ai-sbom/)으로 문서화 상태를 확인합니다.
5. 저장소를 공개하고 운영합니다([공개 절차](../process/)의 D 단계).

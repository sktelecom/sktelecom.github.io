...
이 체크리스트와 [모델 카드 작성](../model-card/)은 순서대로가 아니라 함께 진행하는 것입니다.
...
- [ ] 학습에 쓴 콘텐츠의 요약을 공개할 준비를 했는가? (EU 인공지능법 제53조,
      집행위원회 템플릿으로 작성)
...
- [ ] [모델 카드](../model-card/)의 일곱 항목을 모두 채웠는가? (모델 설명, 의도한 용도,
      용도 밖 사용, 한계와 편향, 학습 데이터, 평가, 연락처)

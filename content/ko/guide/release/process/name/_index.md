...
듣기 좋고 외우기 쉬우며, 어떤 프로젝트인지 나타낼 수 있는 이름으로 짓는 것이 좋다. 문제가 될 소지가 있는 이름은 피해야 한다. 
...
무엇보다도 명확성을 고려하라. 유머가 담긴 이름이 재미있을 수는 있으나 다른 문화나 언어권의 사람에게는 이해되지 않을 수 있다.
...
웹사이트, 트위터 등을 이용한 홍보를 고려해서 미리 원하는 [도메인 이름](https://instantdomainsearch.com/)이나 SNS 계정을 확보할 수 있는지 확인하라. 당장 필요하지 않더라도 미리 확보해 두는 것이 좋다.

## 타사 브랜드를 사용하지 마라.
즉, "Java Test Library" 보다는 "Test Library for Java"가 낫다.

## 상표권을 침해하지 마라.
프로젝트 이름이 상표권을 침해하지 않는지 확인하는 것도 중요하다. 추후 상표권을 가진 회사가 프로젝트 중단을 요청하거나 법적 조치를 취할 수 있다. 이러한 위험을 감수해야 하는 상황을 만들 필요는 없다. Kipris의 [상표권 검색](http://kdtj.kipris.or.kr/kdtj/searchLogina.do?method=loginTM) (해외의 경우 [WIPO Global Brand Databae](https://www3.wipo.int/branddb/en/))에서 상표권 충돌 여부를 확인할 수 있다. 

...
SK텔레콤은 오픈소스 커뮤니티에 참여할 뿐만 아니라 자사의 소프트웨어를 오픈소스로 공개하여 커뮤니티와 협업하는 것을 적극적으로 지원한다. 오픈소스 커뮤니티와의 협업이 그만큼 소중한 가치가 있다고 인식하기 때문이다.

* [오픈소스 공개의 혜택](/guide/release/benefit)

이 문서에서는 SK텔레콤의 소프트웨어를 오픈소스로 공개할 때 법적, 윤리적, 기술적인 문제를 일으키지 않으면서 오픈소스 협업의 이점을 최대한 활용하기 위한 가이드를 제공한다.

## SK텔레콤 오픈소스 공개 Rule

SK텔레콤은 오픈소스 커뮤니티와의 협업 가치를 존중하며, 내부 소프트웨어를 오픈소스 프로젝트로 공개하는 것을 장려한다. 

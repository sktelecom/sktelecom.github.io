...
여러 대의 노드가 하나의 클러스터를 이루는 제품(예: 분산 스토리지)도 제출 단위는 제품당 SBOM 하나입니다. SBOM 단위를 정하는 기준은 [제출 절차](../submission/)의 제출 단위 절을 참고하세요.
...
- [제출 절차](../submission/): 클러스터·다중 노드 구성을 포함한 SBOM 제출 단위

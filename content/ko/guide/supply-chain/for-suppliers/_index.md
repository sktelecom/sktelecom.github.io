...
2. [BomLens](skt-scanner/)로 SBOM을 생성합니다. 자체 도구 체계를 이미 운영한다면 [SBOM 생성 방법](creation-guide/)의 오픈소스 도구 안내를 참고하세요.
3. OS 위에 애플리케이션을 얹어 납품하는 서버라면 [SBOM 생성 방법](creation-guide/#서버-납품)의 서버 납품 절에 따라 층별로 생성하고 정적 링크를 보강해 함께 제출합니다.

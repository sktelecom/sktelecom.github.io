...
SK텔레콤은 구성원이 패치 제공 등의 방법으로 외부 오픈소스 프로젝트에 기여하는 것을 적극 권장한다. 버그를 찾았거나, 코드를 개선했다면 오픈소스 프로젝트에 다시 기여하라. 이는 개인뿐만 아니라 기업에도 혜택이 되기 때문이다.  
* [오픈소스 기여의 혜택](/guide/contribute/benefit)

다만, 몇 가지 염두에 둘 사항이 있다. 흔한 경우는 아니지만 오픈소스 프로젝트와 커뮤니티에 대한 이해와 전략 없이 뛰어들면 실망만 안길 수 있다. 특히 커뮤니티에서 기업의 명성이 떨어질 뿐만 아니라 법적 위험이 발생할 수도 있다. ‌이 가이드는 이러한 법적 문제를 예방하고 오픈소스 커뮤니티와 효과적으로 협업하도록 안내하기 위해 작성했으며, SK텔레콤 구성원이 오픈소스 프로젝트에 기여하기 전에 따라야 할 몇 가지 요구 사항과 올바른 기여 방법을 설명한다.

...
* 오픈소스 프로젝트는 Code를 가능한 자세히 문서화합니다. 
...
개발자가 오픈소스에 기여해야 하는 이유는 다음 블로그에서도 언급하고 있으니 참고하시기 바랍니다. : "[개발자가 오픈소스에 기여해야 하는 이유](https://devocean.sk.com/opensource/techBoardDetail.do?ID=159274)"

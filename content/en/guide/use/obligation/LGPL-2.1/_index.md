...
![Disclosure scope of LGPL-2.1](lgpl-2.1-disclosure-scope.svg "The library itself must be disclosed, a dynamically linked program need not be, and a statically linked executable requires object code")

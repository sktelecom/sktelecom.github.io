...
2. Generate the SBOM with [BomLens](for-suppliers/skt-scanner/). If you use your own tool chain, see [How to Generate an SBOM](for-suppliers/creation-guide/). For a commercial finished product made by a third party, [obtain the SBOM from the manufacturer](for-suppliers/commercial-software/) and submit it.

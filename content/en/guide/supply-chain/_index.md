...
2. Generate the SBOM following [How to Generate an SBOM](for-suppliers/creation-guide/), choosing a tool such as [BomLens](for-suppliers/skt-scanner/). For a commercial finished product made by a third party, [obtain the SBOM from the manufacturer](for-suppliers/commercial-software/) and submit it.

...
3. If you deliver a server with an application on top of an OS, check [Server SBOM](server-delivery/) for the additional steps: covering statically linked libraries and merging.

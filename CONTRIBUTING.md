...
- [1. 오픈소스 프로젝트 등록](#1-오픈소스-프로젝트-등록)
  - [자료 준비](#자료-준비)
  - [자료 제출](#자료-제출)
  - [오픈소스 프로젝트 등록을 위한 Pull Request 방법](#오픈소스-프로젝트-등록을-위한-pull-request-방법)
    - [선행 작업](#선행-작업)
    - [코드 수정](#코드-수정)
...
- [2. 블로그 작가 등록](#2-블로그-작가-등록)
  - [자료 준비](#자료-준비-1)
  - [자료 제출](#자료-제출-1)
  - [작가 등록을 위한 Pull Request 방법](#작가-등록을-위한-pull-request-방법)
    - [선행 작업](#선행-작업-1)
    - [코드 수정](#코드-수정-1)
    - [Commit, Push & Pull Request](#commit-push--pull-request-1)
- [3. 블로그 작성글 등록](#3-블로그-작성글-등록)
  - [자료 준비](#자료-준비-2)
  - [자료 제출](#자료-제출-2)
  - [블로그 등록을 위한 Pull Request 방법](#블로그-등록을-위한-pull-request-방법)
    - [선행 작업](#선행-작업-2)
    - [코드 수정](#코드-수정-2)
    - [Commit, Push & Pull Request](#commit-push--pull-request-2)
- [4. 컴플라이언스 산출물 등록](#4-컴플라이언스-산출물-등록)
  - [자료 준비](#자료-준비-3)
  - [자료 제출](#자료-제출-3)
  - [컴플라이언스 산출물 등록을 위한 Pull Request 방법](#컴플라이언스-산출물-등록을-위한-pull-request-방법)
    - [선행 작업](#선행-작업-3)
    - [코드 수정](#코드-수정-3)
    - [Commit, Push & Pull Request](#commit-push--pull-request-3)
- [개발 환경 설정](#개발-환경-설정)
  - [1. Ruby, Bundler와 Jekyll 설치](#1-ruby-bundler와-jekyll-설치)
  - [2. 테스트 사이트 구동](#2-테스트-사이트-구동)
...
웹사이트 화면 상단에는 여러 메뉴가 있는데요, 다음 두 곳에서 메뉴를 추가/삭제 할 수 있습니다. 
...
웹사이트의 콘텐츠는 여러분의 기여로 채워집니다. [오픈소스 프로젝트](https://sktelecom.github.io/project/), [오픈소스 가이드](https://sktelecom.github.io/guide/) 및 [오픈소스 블로그](https://sktelecom.github.io/blog/)를 작성해주세요. 
